                        ...
                        @foreach ($services as $key =>$service)
                            ...
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <div class="mb-0">
                                        <div class="btn btn-link" role="button" data-toggle="collapse" data-target="#service_{{ $service->id }}" aria-expanded="true" aria-controls="service_{{ $service->id }}">
                                            {{ $service->name }}
                                        </div>
                                    </div>
                                </div>

                                <div id="service_{{ $service->id }}" class="collapse {{ $key == 0 ?'show' : '' }}" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        {!! $service->text !!}
                                    </div>
                                </div>
