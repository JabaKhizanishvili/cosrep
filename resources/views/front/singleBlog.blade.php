...
<main>
    ...
    <div class="image-overly-dark lernen_banner large bg-blog-detail2" style="background: linear-gradient(rgba(0, 0, 0, .3), rgba(0, 0, 0, .1)), url({{ pageImage($page->image) }});">
                        ...
                        <div class="section-title">
                            <div>
                                ...
                                <div class="course-viewer">
                                    <ul>
                                        <li><i class="fas fa-calendar-alt"></i>{{ date('Y-m-d H:i', strtotime($blog->created_at)) }}</li>
                                    </ul>
                                </div>
                        </div>
                        ...
                        <div class="detail-widgets widget_thumb_post">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a class="feed-title" href="{{ route('front.singleBlog', urlencode($blog_->name)) }}">{{ $blog_->name }}</a>
