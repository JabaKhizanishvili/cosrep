...
<h1 class="">Log In to <a href="index.html"><span class="brand-name">{{ config('app.name') }}</span></a></h1>
                        <form method="POST" action="{{ route('login') }}" class="text-left">
                            ...
                            @endif
                                ...
                                <div class="field-wrapper">
                                        <a href="/admin/password/reset" class="forgot-pass-link">Forgot Password?</a>
                                </div>
                            </div>
                        </form>
                    </div>
