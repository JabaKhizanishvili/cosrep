        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                        <a href="{{route('admin.positions.create')}}" class="btn btn-success mb-2 mt-3 mr-2 float-right">
                            ...
                            @foreach ($objects as $object)
                                <tr class="recordTr">
                                    ...
                                    <td class="text-center">
                                        <span>&nbsp; &nbsp;</span>
                                        <a href="{{route('admin.positions.edit', $object)}}?page={{ request('page') }}" class=""><i data-feather="edit" style="color: #8dbf42"></i></a>
    ...
    function fetchDeleteBtn(){
            ...
            deleteBtn.forEach(element => {
                element.addEventListener('click', function(){
                    ...
                    var route = '{{ route("admin.positions.destroy", ":id") }}';
