                        ...
                        <form method="post" action="{{ route('admin.trainings.store') }}" enctype="multipart/form-data"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="placeholder js-states form-control basic" name="trainer_id"
                                        ...
                                        @foreach($trainers as $trainer)
                                            <option
                                                value="{{ $trainer->id }}" {{ $trainer->id == old("trainer_id") ? 'selected' : '' }}>{{ $trainer->email }}</option>
                                        @endforeach
                                    </select>
                                    @error('trainer_id')
                            ...
                            <div class="form-row mb-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" min="1"
                                           class="form-control @error('name') invalideInput @enderror"
                                           id="point_to_pass" placeholder="Point To Pass" name="point_to_pass"
                                           value="{{old('point_to_pass')}}" required>
                                    @error('point_to_pass')
                                    <div class="customValidate">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('title') invalideInput @enderror"
                                           id="title" placeholder="Title" name="title[ge]" value="{{old('title')}}"
                                           required>
                                    @error('title')
                                    <div class="customValidate">
                                        {{ $message }}
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('title') invalideInput @enderror"
                                           id="title" placeholder="Title" name="title[en]" value="{{old('title')}}"
                                           required>
                                    @error('title')
                                    <div class="customValidate">
                                        {{ $message }}
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4">Text (Emglish) </label>
                                    <textarea name="text[en]" id="textarea_1" cols="30" rows="10" class="form-control"
                                              placeholder="Text" required>{{ old('text') }}</textarea>
                                    @error('text')
                                    <div class="customValidate">
                                        {{ $message }}
