            ...
            <div class="col-lg-12">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <form method="post" action="{{ route('admin.trainings.update', $object) }}"
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="placeholder js-states form-control basic" name="trainer_id"
                                            id="trainer_id" required>
                                        @foreach($trainers as $trainer)
                                            <option
                                                value="{{ $trainer->id }}" {{ $trainer->id == $object->trainer_id ? 'selected' : '' }}>{{ $trainer->email }}</option>
                                        @endforeach
                                    </select>
                                    @error('trainer_id')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="placeholder js-states form-control basic" name="category_id"
                                            id="category_id" required>
                                        @foreach($categories as $category)
                                            <option
                                                value="{{ $category->id }}" {{ $category->id == $object->category_id ? 'selected' : '' }}> {{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                                    <div class="customValidate">
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Name (Slug უნიკალური (For URL))</label>
                                    <input type="text" class="form-control @error('name') invalideInput @enderror"
                                           id="name" placeholder="Name" name="name" value="{{ $object->name }}"
                                           required>
                                    @error('name')
                                    <div class="customValidate">
                                        {{ $message }}
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('name') invalideInput @enderror"
                                           id="point_to_pass" placeholder="Point To Pass" name="point_to_pass"
                                           value="{{$object->point_to_pass}}" required>
                                    @error('point_to_pass')
                                    <div class="customValidate">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('title') invalideInput @enderror"
                                           id="title[ge]" placeholder="title" name="title[ge]"
                                           value="{{ $object->title }}"
                                           required>
                                    @error('title')
                                    <div class="customValidate">
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('title') invalideInput @enderror"
                                           id="title[en]" placeholder="title" name="title[en]"
                            ...
                            <div class="form-row mb-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <img src="{{ trainingImage($object->image) }}" alt="" style="width: 100%">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="answers-container row" style="width: 100%">
                                    ...
                                    @if($object->resources)
                                        @foreach (json_decode($object->resources, true) as $resource)
                                            <div class="form-group col-md-12 single-answer">
                                                ...
                                                <input type="text" class="form-control mb-2" placeholder="Name"
                                                       name="names[]" value="{{ $resource['name'] }}" required>
                                                <input type="text" class="form-control"
                                                       placeholder="https://example.com" name="urls[]"
                                    ...
                                    @if(old('names'))
                                        ...
                                        @foreach (old('names') as $k => $old)
                                            <div class="form-group col-md-12 single-answer">
                                                ...
                                                <label for="inputEmail4">URL</label>
                                                <input type="text" class="form-control mb-2" placeholder="Name"
                                                       name="names[]" value="{{ $old }}" required>
                                                <input type="text" class="form-control"
                                                       placeholder="https://example.com" name="urls[]"
                                                       value="{{ $urls[$k] }}" required>
                                            </div>
                                        @endforeach
