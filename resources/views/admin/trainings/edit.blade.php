        ...
        <div class="col-lg-12">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <form method="post" action="{{ route('admin.trainings.update', $object) }}" enctype="multipart/form-data" id="submitForm">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <select class="placeholder js-states form-control basic" name="trainer_id" id="trainer_id" required>
                                    ...
                                    <option value="{{ $trainer->id }}" {{ $trainer->id == $object->trainer_id ? 'selected' : '' }}>{{ $trainer->email }}</option>
                                    @endforeach
                                </select>
                                @error('trainer_id')
                        ...
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control @error('name') invalideInput @enderror" id="point_to_pass" placeholder="Point To Pass" name="point_to_pass" value="{{$object->point_to_pass}}" required>
                                @error('point_to_pass')
                                    <div class="customValidate">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="text" id="textarea_1" cols="30" rows="10" class="form-control" placeholder="Text" required>{{ $object->text }}</textarea>
                                @error('text')
                                <div class="customValidate">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="answers-container row" style="width: 100%">
                                ...
                                @if($object->resources)
                                        ...
                                        <div class="form-group col-md-12 single-answer">
                                            ...
                                            <input type="text" class="form-control mb-2" placeholder="Name" name="names[]" value="{{ $resource['name'] }}" required>
                                            <input type="text" class="form-control" placeholder="https://example.com" name="urls[]" value="{{ $resource['url'] }}" required>
                                        </div>
                                        @endforeach
                                @endif
