                ...
                <div class="widget-content widget-content-area">
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <select class="placeholder js-states form-control basic" name="type" id="type" required>
                ...
                <div class="widget-content widget-content-area">
                    <div class="col-md-12 pl-0">
                        <div id='left-lovehandles' class='dragula ui-sortable'>
                            ...
                            <div class="media d-block d-xl-flex recordTr singleSort ml-0 pl-0" id="{{ $m->id }}">
                                ...
                                <div class="media-body">
                                    <div class="d-sm-flex d-block justify-content-between text-sm-left text-center">
                                        ...
                                        <div class="col-md-6 existingMedia">
                                            <a href="{{ route("admin.trainings.deleteMedia", $m) }}" onclick="return confirm('Are you sure?')" class="deleteExistingMedia btn-sm btn-danger">Delete</a>
                                            <form action="{{ route('admin.trainings.updateMedia', $m) }}" method="post">
                                                @csrf
                                                @method('put')
                                                <ul>
                                                    <li>TYPE: {{ $m->type }}</li>
                                                    <li>NAME: <input type="text" name="name" id="" value="{{ $m->name }}" class="form-control"></li>


                                                    <li>URL: <a href="{{ amazon_s3_url($m->path) }}" target="_blank">{{ amazon_s3_url($m->path) }}</a></li>
                                                    @if($m->type == \App\Models\TrainingMedia::TYPE_DOCUMENT)
                                                    <embed src="{{ amazon_s3_url($m->path) }}#toolbar=0" type="application/pdf" width="100%" height="600px" />
                                                @elseif($m->type == \App\Models\TrainingMedia::TYPE_VIDEO)
                                                    <video width="320" height="240" controls controlsList="nodownload">
                                                        <source src="{{ amazon_s3_url($m->path) }}" type="video/mp4">
                                                    Your browser does not support the video tag.
                                                    </video>
                                                @endif
                                                </ul>
                                                <button class="mt-2 btn-sm btn-warning">Update</button>
