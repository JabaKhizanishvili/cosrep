                            ...
                            <div class="col-md-12">
                                <div id='left-lovehandles' class='dragula ui-sortable'>
                                    @foreach ($objects as $key =>  $object)
                                        ...
                                        <div class="media  d-block d-xl-flex recordTr singleSort"
                                             id="{{ $object->id }}">
                                            ...
                                            <div class="media-body">
                                                <div
                                                    ...
                                                    <div class="" style="width: 10%">
                                                        <h5 class="">{{ \Str::limit($object->slug),100, '...' }}</h5>
                                                    </div>
                                                    ...
                                                    <div>
                                                        @if($object->isMainPage())
                                                            <span class="badge badge-info">Menu Page</span></td>
                                                        @else
                                                            &nbsp;
                                                            &nbsp;
                                                            &nbsp;
        ...
        @section('script')
            ...
            <script type="text/javascript">
                ...
                function updateOrder(data) {
                    ...
                    ajaxCall('POST', '{{route('admin.pages.position')}}', {"position": data}, function (e) {
                        Snackbar.show({
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    function tableContent(data) {
                        var status = '';
                        let route_rul = '{{route('admin.pages.edit', ":id")}}';
