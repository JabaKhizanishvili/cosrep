        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                        <a href="{{route('admin.appointments.create')}}" class="btn btn-success mb-2 mt-3 mr-2 float-right">
                ...
                <form action="" method="get">
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="placeholder js-states form-control basic" name="training_id" id="training_id">
                                <option value="">None</option>
                                @foreach ($trainings as $training)
                                    <option value="{{ $training->id }}"
                                        {{ request('training_id') == $training->id ? 'selected' : '' }}>{{ $training->id }}: {{ limit_words($training->name, 15) }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            @foreach ($objects as $object)
                                <tr class="recordTr">
                                    ...
                                    @if($object->reported)
                                        ...
                                        <form action="{{ route('admin.appointments.resend', $object) }}" method="POST">
                                            @csrf
                                            <input class="btn-sm btn-info" type="submit" name="" id="" value="Re-send">
                                        </form>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('admin.appointments.edit', $object)}}?page={{ request('page') }}" class=""><i data-feather="edit" style="color: #8dbf42"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </div>
