                        ...
                        <div>
                            @foreach ($objects as $object)
                                <tr class="recordTr">
                                    ...
                                    <td>
                                        <ul>
                                            <li>Start: {{ $object->start_date }}</li>
                                            <li>End:&nbsp;&nbsp; {{ $object->end_date }}</li>
                                        </ul>
                                    <td>{{ $object->repeat }}</td>
                                    <td>

                                        <ul>
                                            <li>Start: {{ $object->repeatStartDate() }}</li>
                                            <li>End:&nbsp;&nbsp; {{ $object->repeatEndDate() }}</li>
                                        </ul>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('admin.appointments.repeat', $object)}}?page={{ request('page') }}" class="btn-sm btn-success">REPEAT</a>
                                    </td>
                                </tr>
                            @endforeach
                        </div>
