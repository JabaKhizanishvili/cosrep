                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4></h4>
                            <a target="_blank" href="{{ route('admin.sections.edit', 1) }}" class="btn btn-info">Edit Section</a>
                            <a target="_blank" href="{{ route('admin.trainers.index') }}" class="btn btn-info">Edit Trainers</a>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    <form method="post" action="{{ route('admin.about.update', $object->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control @error('title') invalideInput @enderror" id="phone" placeholder="Phone" name="title" value="{{$object->title}} " required>
                                @error('title')
