        ...
        <div class="col-lg-12">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <form method="post" action="{{ route('admin.trainers.store') }}" enctype="multipart/form-data" id="submitForm">
                        @csrf
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <input type="url" class="form-control @error('facebook') invalideInput @enderror" id="facebook" placeholder="Facebook" name="facebook" value="{{old('facebook')}}">
                                @error('facebook')
                                    <div class="customValidate">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="url" class="form-control @error('linkedin') invalideInput @enderror" id="linkedin" placeholder="Twitter" name="twitter" value="{{old('twitter')}}">
                                @error('twitter')
                                    <div class="customValidate">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <input type="url" class="form-control @error('linkedin') invalideInput @enderror" id="linkedin" placeholder="Linkedin" name="linkedin" value="{{old('linkedin')}}">
                                @error('linkedin')
                                    <div class="customValidate">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="url" class="form-control @error('Instagram') invalideInput @enderror" id="Instagram" placeholder="Instagram" name="instagram" value="{{old('instagram')}}">
                                @error('Instagram')
                                    <div class="customValidate">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-md-6">
                                <div class="widget-content widget-content-area">
                                    <div class="custom-file-container" data-upload-id="mySignature">
                                        <label>Upload Signature  <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear">x</a></label>
                                        <label class="custom-file-container__custom-file" >
