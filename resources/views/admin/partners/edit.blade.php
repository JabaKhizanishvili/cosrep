            ...
            <div class="col-lg-12">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <form method="post" action="{{ route('admin.partners.update', $object) }}"
                            ...
                            <div class="form-row mb-4">
                                <div class="shadow p-3 mb-5 col-7 bg-body rounded">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('name') invalideInput @enderror"
                                               ...
                                               value="{{$object->getTranslation('name','ge')}}" required>
                                        @error('name')
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('name') invalideInput @enderror"
                                               ...
                                               value="{{$object->getTranslation('name','en')}}" required>
                                        @error('name')
                                        <div class="customValidate">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="url" class="form-control @error('url') invalideInput @enderror"
                                           id="url" placeholder="url" name="url" value="{{$object->url}}">
                                    @error('url')
                                    <div class="customValidate">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-row mb-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <img src="{{ partnerImage($object->image) }}" alt=""
